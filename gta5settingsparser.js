...
function writeSettings(){
	...
	// Anti-aliasing
	// GTA V Enhanced exposes anti-aliasing through the Frame Scaling controls.
	// AAType is retained internally by the game, but is not shown as a standalone
	// TAA quality option in the Enhanced graphics menu.
	if (!enhanced) {
	...
	if (enhanced) {
	    ...
	    if (rtEnabled == "true") {
	        ...
	        // The supplied recording shows Presets/BVHQuality value 1 as Very High.
